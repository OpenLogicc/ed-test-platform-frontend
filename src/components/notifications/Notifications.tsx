    ...
    <div>
      ...
      >
        <div className="border-b border-slate-700 pb-4 mb-5 flex items-center">
          <h5
            id="drawer-label"
            className="inline-flex items-center text-lg font-bold text-white"
          >
            <svg
              className="w-5 h-5 me-2 text-blue-400"
              aria-hidden="true"
        ...
        <p className="mb-4 text-sm text-slate-300 leading-relaxed">
          Stay updated with the latest notifications and important updates from
          your dashboard.
        </p>
