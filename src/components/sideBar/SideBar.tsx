...
export const SideBar: React.FC<SideBarProps> = ({ onLinkClick, isOpen, setIsOpen }) => {
                    ...
                    <ul className="space-y-3 font-medium">
                        ...
                        <li>
                            ...
                            >
                                ...
                                <span className="ml-auto text-xs bg-red-500/20 text-red-300 px-2 py-1 rounded-full">5</span>
                            </button>
                        </li>
